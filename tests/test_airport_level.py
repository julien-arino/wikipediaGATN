...
import wikipediaGATN.wikipedia_airport_level as wal

@mock.patch("wikipediaGATN.wikipedia_airport_level._SESSION.get")
def test_get_wikipedia_airport_page_link_url(mock_get):
    ...
    assert wal.get_wikipedia_airport_page_link(url) == url

    with pytest.warns(UserWarning, match="Invalid Wikipedia URL"):
        assert wal.get_wikipedia_airport_page_link("https://example.com/not_a_wiki") is None

@mock.patch("wikipediaGATN.wikipedia_airport_level._SESSION.get")
def test_get_wikipedia_airport_page_link_iata(mock_get):
    mock_response = mock.MagicMock()
    mock_response.json.return_value = {
        "query": {
            "search": [
...
@mock.patch("wikipediaGATN.wikipedia_airport_level._SESSION.get")
def test_get_wikipedia_airport_page_link_freetext(mock_get):
    mock_response = mock.MagicMock()
    mock_response.json.return_value = {
        "query": {
            "search": [
    ...
    result = wal.get_wikipedia_airport_page_link("London Heathrow")
...
@mock.patch("wikipediaGATN.wikipedia_airport_level._SESSION.get")
def test_get_wikipedia_airport_page_link_freetext_has_airport(mock_get):
    mock_response = mock.MagicMock()
    mock_response.json.return_value = {
        "query": {
            "search": [
    ...
    result = wal.get_wikipedia_airport_page_link("London Heathrow Airport")
...
@mock.patch("wikipediaGATN.wikipedia_airport_level._SESSION.get")
def test_get_wikipedia_airport_page_link_no_results(mock_get):
    mock_response = mock.MagicMock()
    mock_response.json.return_value = {
        "query": {
            "search": []
    ...
    with pytest.warns(UserWarning, match="No Wikipedia page found"):
        result = wal.get_wikipedia_airport_page_link("XYZ")

    assert result is None

@mock.patch("wikipediaGATN.wikipedia_airport_level._SESSION.get")
def test_get_wikipedia_airport_page_link_prefer_airport_title(mock_get):
    mock_response = mock.MagicMock()
    mock_response.json.return_value = {
        "query": {
            "search": [
    ...
    result = wal.get_wikipedia_airport_page_link("LAX")

    assert result == "https://en.wikipedia.org/wiki/Los_Angeles_International_Airport"

@mock.patch("wikipediaGATN.wikipedia_airport_level._SESSION.get")
def test_get_wikipedia_airport_page_link_verbose(mock_get, capsys):
    mock_response = mock.MagicMock()
    mock_response.json.return_value = {
        "query": {
            "search": [
    ...
    result = wal.get_wikipedia_airport_page_link("YWG", verbose=True)
...
@mock.patch("wikipediaGATN.wikipedia_airport_level._SESSION.get")
def test_get_wikipedia_airport_page_link_verbose_url(mock_get, capsys):
    mock_response = mock.MagicMock()
    mock_response.json.return_value = {
        "query": {
            "search": [
    ...
    url = "https://en.wikipedia.org/wiki/Winnipeg_James_Armstrong_Richardson_International_Airport"
    result = wal.get_wikipedia_airport_page_link(url, verbose=True)
    captured = capsys.readouterr()
